...
import { AssetChartComponent } from '@/app/assets/[assetSymbol]/AssetChartComponent';
import { WalletList } from '@/components/WalletList';
import {getAssetDailies, getAssetsBySymbol} from '@/queries/asset-queries';
...
export default async function AssetDashboard({ params, searchParams }: {
  ...
  const asset = await getAssetsBySymbol(assetSymbol);
  ...
  return (<div className="flex flex-col space-y-5 flex-grow">
    ...
    <AssetSync assetSymbols={[asset.symbol]} />
  </div>);
}